...
import { loginWithEmailAndPassword, signInWithGoogle, resetPassword } from "@/lib/firebase/auth-service"
...
export function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        <CardTitle>Login to Aestrix</CardTitle>
      ...
      <CardContent>
        ...
        {resetSent && (
          <Alert className="mb-4 bg-green-900 text-white">
      ...
      <CardFooter className="flex justify-center">
        <Button type="button" variant="link" className="text-gray-400" onClick={() => router.push("/signup")}>
